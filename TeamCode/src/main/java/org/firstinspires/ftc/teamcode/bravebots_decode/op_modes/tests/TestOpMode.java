...
public class TestOpMode extends BetterOpMode {
    ...
    public void initialize() {
        ...
        gamepadEx1.getButton(BetterGamepad.Buttons.SQUARE).whenPressed(()-> Shooter.m.setVelocity(-1400));
        gamepadEx1.getButton(BetterGamepad.Buttons.TRIANGLE).whenPressed(()->Shooter.m.setVelocity(0));
